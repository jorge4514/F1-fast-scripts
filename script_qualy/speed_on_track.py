...
ff1.Cache.enable_cache(r'C:\Users\jorge\Desktop\fastf1\cache')  # replace with your cache directory
...
plot_title = f"{session.event.year} {session.event.EventName} - {session.name} SPEED LAP"
